...
sys.path.insert(0, os.path.join(os.path.dirname(os.path.abspath(__file__)), '..') if '__file__' in dir() else 'python_scripts')
    ...
    for fac in faciter:
        ...
        # cond = 'true'
            ...
            # n = 1000
                ...
                with open('./python_scripts/Results/Simulation2_m_est'+str(job_id)+'_'+str(reg)+'_h'+str(fac)+'_condmod_'+str(cond)+'_n_'+str(n)+'_selfnorm.dat', 'wb+') as file:
                ...
                with open('./python_scripts/Results/Simulation2_theta_est'+str(job_id)+'_'+str(reg)+'_h'+str(fac)+'_condmod_'+str(cond)+'_n_'+str(n)+'_selfnorm.dat', 'wb+') as file:
...
for n in niter:
    ...
    for cond in conditer:
        print(cond)
        with open('./python_scripts/Results/Simulation2_m_est'+str(job_id)+'_'+str(reg)+'_h'+str(fac)+'_condmod_'+str(cond)+'_n_'+str(n)+'_selfnorm.dat', "rb") as file:
